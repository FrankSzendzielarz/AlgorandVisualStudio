...
namespace AlgoStudio.VSIX
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ImportContractJSONForSCP
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private ImportContractJSONForSCP(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static ImportContractJSONForSCP Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new ImportContractJSONForSCP(package, commandService);
        }
        ...
        private async void Execute(object sender, EventArgs e)
        {
            ...
            fd.Title = "Open Algorand app.json for Proxy generation";
            ...
            if (fd.ShowDialog() ?? false)
            {
                ...
                var previewDialog = new ContractJsonToSCP(cd, nameSpace);
