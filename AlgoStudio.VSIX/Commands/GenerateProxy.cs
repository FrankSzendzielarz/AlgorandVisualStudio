...
namespace AlgoStudio.VSIX
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class GenerateProxy
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private GenerateProxy(AsyncPackage package, OleMenuCommandService commandService)
        {
                    ...
                    if (semanticModel != null)
                    {
                        try
                        {
                            ...
                            if (classDeclaration != null)
                            {
                                ...
                                myCommand.Visible = AlgoStudio.Compiler.Utilities.IsSmartContract(classSymbol as INamedTypeSymbol) || AlgoStudio.Compiler.Utilities.IsSmartSignature(classSymbol as INamedTypeSymbol);
                            }
                            else
                                myCommand.Visible = false;
                        }
        ...
        /// </summary>
        public static GenerateProxy Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new GenerateProxy(package, commandService);
        }
        ...
        private async void Execute(object sender, EventArgs e)
        {
            ...
            if (textView != null)
            {
                ...
                if (classDeclaration != null)
                {
                    ...
                    try
                    {
                        string proxy = Clients.ProxyGenerator.Generate(semanticModel, classDeclaration, "Proxies", out string className);
                        ...
                        if (!String.IsNullOrWhiteSpace(proxy))
                        {
                            ...
                            sd.DefaultExt = ".cs";
                            sd.FileName = className + ".cs";

                            if (sd.ShowDialog() ?? false)
                            {
                                File.WriteAllText(sd.FileName, proxy);
                            }
                        }
                        else
                        {
