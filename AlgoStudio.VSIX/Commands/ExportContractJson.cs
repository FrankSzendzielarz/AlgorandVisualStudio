...
namespace AlgoStudio.VSIX
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ExportContractJson
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private ExportContractJson(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static ExportContractJson Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new ExportContractJson(package, commandService);
        }
            ...
            if (classDeclaration != null)
            {
                try
                {
                    ...
                    if (appModel != null)
                    {
                        ...
                        sd.Title = "Save App.json";
                        sd.Filter = "JSON file (.json)|*.json";
                        sd.DefaultExt = ".json";
                        sd.FileName = "app.json";

                        if (sd.ShowDialog() ?? false)
                        {
                            appModel.SaveToFile(sd.FileName);
                        }
                    }
                    else
                    {
