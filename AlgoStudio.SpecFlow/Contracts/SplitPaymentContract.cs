...
namespace AlgoStudio.TestContracts.Contracts
{
    public class SplitPayments : SmartContract
    {
        ...
        public bool SplitPayment(PaymentTransactionReference incomingPayment, [ABITypeDecorator("ufixed32x3")]uint percentageOne, AccountReference split1, AccountReference split2, AppCallTransactionReference current)
        {
