...
{
    public class UInt8Conditions : SmartContract
    {
        ...
        public bool NotEquals(byte a, byte b)
        {
            return a != b;
        }

        [SmartContractMethod(OnCompleteType.NoOp, "Greater")]
        public bool Greater(byte a, byte b)
        {
            return a > b;
        }
        ...
        public bool GreaterOrEquals(byte a, byte b)
        {
            return a >= b;
        }

        [SmartContractMethod(OnCompleteType.NoOp, "LessOrEquals")]
        public bool LessOrEquals(byte a, byte b)
        {
            return a <= b;
        }
