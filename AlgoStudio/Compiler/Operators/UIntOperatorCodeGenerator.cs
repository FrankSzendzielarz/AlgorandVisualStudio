...
{
    internal class UIntOperatorCodeGenerator : NumericCodeGenerator
    {

        const ulong byteMask = 0x_00000000_ffffffff;
        ...
        public UIntOperatorCodeGenerator(CodeBuilder code) : base(code)
        {
        }
